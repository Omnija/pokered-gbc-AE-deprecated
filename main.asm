...
INCLUDE "gfx/sprites1.asm" ; Sprites Moved

SECTION "NPC Sprites 2", ROMX ; BANK $05
INCLUDE "gfx/sprites2.asm" ; Sprites Moved

SECTION "Graphics (BANK 4)", ROMX
INCLUDE "gfx/title.asm" ; Titlescreen Moved
...
INCLUDE "gfx/player.asm" ; Player Moved
...
INCLUDE "gfx/pics1.asm" ; Pics 1 Moved
SECTION "Pics 2", ROMX ; BANK $0A
INCLUDE "gfx/pics2.asm" ; Pics 2 Moved
