...
KadabraEvosMoves:
; Evolutions
;	db EV_TRADE, 1, ALAKAZAM # Disable Trade Evolution
...
GravelerEvosMoves:
; Evolutions
;	db EV_TRADE, 1, GOLEM # Disable Trade Evolution
...
MachokeEvosMoves:
; Evolutions
;	db EV_TRADE, 1, MACHAMP # Disable Trade Evolution
...
HaunterEvosMoves:
; Evolutions
;	db EV_TRADE, 1, GENGAR # Disable Trade Evolution
