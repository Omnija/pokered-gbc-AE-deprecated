...
IF DEF(_RED)
	INCBIN "gfx/versions/red/intro_nido_1.2bpp"
FightIntroFrontMon2:
	INCBIN "gfx/versions/red/intro_nido_2.2bpp"
FightIntroFrontMon3:
	INCBIN "gfx/versions/red/intro_nido_3.2bpp"
ENDC

IF DEF(_BLUE)
	INCBIN "gfx/versions/blue/intro_purin_1.2bpp"
FightIntroFrontMon2:
	INCBIN "gfx/versions/blue/intro_purin_2.2bpp"
FightIntroFrontMon3:
	INCBIN "gfx/versions/blue/intro_purin_3.2bpp"
ENDC
